...
@section('content_servicios')

<div class="header-sitio interno">
				
            <div class="container">				
                <div class="sixteen columns">
                	<a href="index.html"><img src="images/logos/ceprog_logo_header.png" alt="CEPROG" /></a>
                </div>
                  ...
                  <nav>
                    <ul id="navigation" class="slimmenu">
                        <li><a href="#">Campus</a>
                        	<ul>
                                <li><a class="outside" href="palenque_home_interno.html">Palenque</a></li>
                                <li><a class="outside" href="Reforma_home_interno.html">Reforma</a></li>
                                <li><a class="outside" href="San_Cristobal_home_interno.html">San Cristobal</a></li>
                                <li><a class="outside" href="Tuxtla_home_interno.html">Tuxtla</a></li>
                            </ul>
                        </li>       
                    </ul>
                </nav>
    ...
    <div id="separator6">
		...
		<div class="subtitulo">
        	<div class="container">				
			<div class="sixteen columns ">
	        	<p><a href="index.html">Inicio</a> / <span>Servicios Escolares</span></p>
            </div>
            </div>
        </div>
